...
Open `02_VERIFY_API_ACCESS_PROMPT.md`, replace the three bracketed values, and give the prompt to an AI agent that can reach the Gateway. A successful health response includes `ok: true`, `tokenConfigured: true`, and runner version `0.3.200`.
