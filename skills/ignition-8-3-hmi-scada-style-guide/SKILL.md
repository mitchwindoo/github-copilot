---
name: ignition-8-3-hmi-scada-style-guide
description: Style Ignition 8.3 Perspective, HMI, SCADA, MES, OEE, downtime, and production visualization screens for industrial users. Use when Codex needs 8.3-specific visual design rules, component appearance, semantic color, layout hierarchy, alarm/abnormal-state styling, typography, chart/table styling, or high-performance HMI guidance for an industrial interface after the functional scope is already known.
---

# Ignition HMI/SCADA Style Guide

Skill version: `1.0.23`
Stack version: `starter-2026.07.18.01`
...
- Primary platform: Ignition 8.3 Perspective.
- Version boundary: apply the visual hierarchy, semantic color, typography, component-state, and operator-workflow rules to Ignition 8.3 only; do not use this skill as guidance for Ignition 8.1 projects.
